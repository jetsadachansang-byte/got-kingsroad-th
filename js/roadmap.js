    ...
    const UPDATES = {
        ...
        "story-chapter-4": {
            ...
            body: [
                ...
                { list: [
                    "RP ฟื้นฟู 1 หน่วยทุก 10 นาที เพดานปกติ 300 หน่วย (600 หน่วยสำหรับผู้ถือ Complete Membership) — ควรตั้งเวลาล็อกอินให้เกจเต็มพอดีช่วงอัปเดตลง เพราะ RP หยุดฟื้นฟูเมื่อถึงเพดาน",
                    "คราฟ 'Summer Fragrant Wine' ไว้ล่วงหน้า เพราะคราฟได้สูงสุด 12 ขวดต่อสัปดาห์ และไอเทมหมดอายุใน 14 วัน"
                ]},
                { p: "หมายเหตุ: รายการเตรียมตัวนี้อ้างอิงคำแนะนำจากสื่อเกม (Gamemeca) ตัวเลขอาจคลาดเคลื่อนได้ ควรตรวจสอบในเกมอีกครั้ง" }
            ],
