    ...
    const UPDATES = {
        ...
        "drowned-god-wakes": {
            ...
            body: [
                ...
                { h: "พื้นที่ใหม่: The Crow's Nest" },
                { p: "ดินแดนใหม่ทางใต้ของ Stormlands พร้อมเควสหลัก เควสย่อย ซากปรักหักพัง (Ruins) และภารกิจตามล่า (Bounties) ผู้เล่นจะได้พบ Stannis Baratheon ผู้อ้างสิทธิ์ในบัลลังก์เหล็ก ท่ามกลางการทรยศ เมื่อทหารรับจ้างที่จ้างมาเสริมทัพกลับยึด Griffin's Roost" },
                { h: "โหมด Raid: Kraken" },
                { list: [
