...
(function () {
    ...
    const GUIDES = {
        ...
        "events": {
            ...
            body: [
                { h: "สรุปข่าว 1 ส.ค. 2026" },
                { p: "ผลจัดอันดับตระกูลสัปดาห์แรกของ Frost and Steel — House Hornwood คว้าอันดับ 1 ด้วยคะแนนสะสม 591,705 คะแนน ตามด้วย House Umber และ House Manderly (Hornwood เป็นตระกูลยอดนิยมสุดตั้งแต่วันแรก ราว 50% ของผู้เล่น)" },
                { p: "ผู้พัฒนาประกาศปรับระบบสกุลเงิน Iron Bank Marks — เตรียมปิดช่องทางเติมเงินวันที่ 19 ส.ค. 2026 สินค้าบางส่วนที่เคยซื้อด้วย Iron Bank Marks จะปรับให้ซื้อด้วย Golden Dragon แทน ผู้เล่นที่มี Iron Bank Marks สะสมควรวางแผนใช้ก่อนวันที่มีผล" },
                { p: "อีเวนต์สุดสัปดาห์ Hot Time เพิ่มอัตราได้รับวัสดุ 'Bronze' จากการเคลียร์ Faction Hideout, Ferocious Animal, Memory of Weirwood และ Smoking Shack" },
                { p: "ดูรายละเอียดที่หน้า Roadmap → สรุปซีซัน 1 สัปดาห์แรก + ประกาศปรับสกุลเงิน" },
                { h: "อัปเดตล่าสุด 29 ก.ค. 2026" },
                { p: "ไฮไลต์อัปเดตล่าสุดของเซิร์ฟเวอร์ปัจจุบัน:" },
                { list: [
                    "ขยายระดับความยากเวิลด์ [Lv.5 ทหารติดอาวุธ ขั้น 3] ปลดล็อกด้วยการเคลียร์ทะลุขีดจำกัด ขั้น 5 — เพิ่มโอกาสได้อุปกรณ์ Tier 4 ระดับตำนาน และรางวัลเวิลด์บอส 'โดรกอน เงามืด'",
                    "เพิ่มทะลุขีดจำกัด ขั้น 5 (พลังต่อสู้ที่แนะนำ 132,000 ขึ้นไป)",
                    "เปลี่ยนตระกูลซีซันได้ 1 ครั้ง ระหว่าง 29–30 ก.ค. เวลา 06:59 น. (ICT) โดยพอยต์สะสมถูกหัก 5%",
                    "เพิ่มสเตจสุดท้าย 'พื้นที่ไร้ขอบเขต' ในวอร์มวอล์คซีซัน นับพอยต์จากจำนวนมอนสเตอร์ที่กำจัดได้ในเวลาที่กำหนด"
                ]},
                { p: "ดูรายการปรับปรุงและแก้บั๊กฉบับเต็มได้ที่หน้า Roadmap → อัปเดต 29 ก.ค. 2026" },
