...
(function () {
    ...
    const GUIDES = {
        ...
        "events": {
            ...
            body: [
                { h: "อัปเดต 24 ก.ค. 2026 (7/24 Update)" },
                { p: "อัปเดตล่าสุดของเซิร์ฟเวอร์ปัจจุบัน เพิ่มอีเวนต์จำกัดเวลา (limited-time) ใหม่ พร้อมแก้ไขบั๊กที่พบและปรับปรุงประสบการณ์การเล่นโดยรวม — ต่อเนื่องจากช่วงซีซัน Frost and Steel และ Duel Festival ตรวจสอบรายละเอียดฉบับเต็มได้ที่ประกาศอัปเดตทางการ (ดูที่มาด้านล่าง)" },
            ...
            source: { label: "Netmarble TH — 7/24 Update Notes", url: "https://forum.netmarble.com/got_th/view/4/211" }
        },
        "codes": {
