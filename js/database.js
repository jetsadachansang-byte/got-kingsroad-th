...
(function () {
    ...
    const DB = {
        ...
        "outfit-system": {
            ...
            tags: ["Cosmetic", "Outfit", "Customization", "Legendary"], confidence: "Official", version: "เซิร์ฟปัจจุบัน (หลัง 21 พ.ค. 2026)", verified: "ส.ค. 2026",
            summary: "เปลี่ยนหน้าตาตัวละครได้อิสระโดยไม่ขึ้นกับเกราะที่ใส่จริง — ในเกมเรียก 'ชุดเกราะแฟชั่น' แยกตามอาชีพ เพศ และระดับความหายาก",
            meta: [
                { k: "ชื่อในเกม (ไทย)", v: "ชุดเกราะแฟชั่น" },
                { k: "แยกตาม", v: "อาชีพ + เพศ (ชาย/หญิง)" },
                { k: "ระดับความหายาก", v: "มีหลายระดับ สูงสุดที่พบคือ ตำนาน (Legendary)" },
            ...
            body: [
                ...
                { h: "ข้อมูลที่ระบุบนชุดแต่ละชิ้น" },
                { p: "หน้ารายละเอียดของชุดเกราะแฟชั่นแต่ละชิ้นจะระบุ 4 อย่างนี้เสมอ:" },
                { list: [
                    "ประเภท — ระบุว่าเป็น 'ชุดเกราะแฟชั่น' (แยกจากเกราะที่ให้ค่าสถานะจริง)",
                    "อาชีพ — ชุดผูกกับอาชีพ เช่น มือสังหาร (Assassin) ใส่ข้ามอาชีพไม่ได้",
                    "เพศ — มีแยกรูปแบบชายและหญิง",
                    "ระดับ — ความหายากของชุด เช่น ตำนาน (Legendary)"
                ]},
                { img: "images/cosmetic/outfit-detail-example.webp", imgW: 555, imgH: 450, caption: "ตัวอย่างหน้ารายละเอียดชุดเกราะแฟชั่น — ระบุประเภท อาชีพ (มือสังหาร) เพศ (ชาย) และระดับ (ตำนาน)" },
                { h: "จุดที่ควรรู้" },
                { list: [
                    "ชุดแฟชั่นเป็นของ 'รายตัวละคร' ไม่ใช่ของบัญชี — ตัวละครแต่ละตัวมีคลังชุดของตัวเอง",
                    "เพราะผูกกับอาชีพและเพศ ควรดูให้ตรงกับตัวละครที่จะใส่ก่อนซื้อ",
