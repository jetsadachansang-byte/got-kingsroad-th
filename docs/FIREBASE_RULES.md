# Firebase Rules สำหรับ Skill Tree ชุมชน

หน้า `skilltree.html` เก็บข้อมูลที่ผู้เล่นเพิ่มเองไว้บน Firebase Realtime Database
...
| กฎ | ผลลัพธ์ |
|---|---|
| `.read: true` | ทุกคนอ่านข้อมูล Skill Tree ได้ (จำเป็น เพราะเป็นเว็บสาธารณะ) |
...
> หมายเหตุ: การลบโพสต์ต้องส่ง `tok` เดิมมาด้วย ซึ่ง Firebase จะเห็นเป็น `newData` ว่าง
